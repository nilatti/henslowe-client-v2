...
export const DATE_FORMAT_WITH_WEEKDAY = 'EEEE, MMMM d';
export const DATE_FORMAT_WITH_MONTH_NAME = 'MMMM d, yyyy';
export const DATE_TIME_FORMAT = 'MM/dd/yyyy hh:mm a';
export const DATE_TIME_FORMAT_FOR_RAILS = "yyyy-MM-dd'T'HH:mm:ssxxx";
...
export const SPACE_ADMIN: string[] = [];
...
export const TIME_FORMAT_FOR_RAILS = 'HH:mmxxx';
